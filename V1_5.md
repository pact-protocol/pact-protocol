...
This document describes the new features and improvements in PACT v1.5, building on the stable v1.0 foundation.
...
## Future Work (Not in v1.5)

- Third-party credential issuers (beyond self-signed)
- Credential revocation lists
- Credential chaining / delegation
- Hardware security module (HSM) integration
- Credential refresh / rotation

These features may be added in future versions but are explicitly **not** in v1.5.
